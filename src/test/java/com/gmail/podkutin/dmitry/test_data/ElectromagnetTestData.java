...
public class ElectromagnetTestData implements TestData<Electromagnet> {
    ...
    public static Electromagnet getClone(Electromagnet electromagnet) {
        return Electromagnet.builder()
                .id(electromagnet.getId())
                .electromagnetModel(ElectromagnetModel.builder().id(electromagnet.getElectromagnetModel().getId())
                        .model(electromagnet.getElectromagnetModel().getModel()).build())
                .amount(electromagnet.getAmount())
                .price(electromagnet.getPrice())
                .voltage(electromagnet.getVoltage()).build();
    }
}
